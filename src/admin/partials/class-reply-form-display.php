        ...
        <div class="bonaire-reply-form-container">
            <form id="bonaire_reply_form" method="post" data-nonce="<?php echo $nonce ?>">
                <div>
                    ...
                    <input type="text" name="name" data-key="name" data-form-input="bonaire" title="<?php echo __( 'Name', self::$domain ) ?>" value="<?php echo $name ?>">
                </div>
                <div>
                    <label for="email"><?php echo __( 'Recipient', self::$domain ) ?></label>
                    <input type="email" name="email" data-key="email" data-form-input="bonaire" title="<?php echo __( 'Email', self::$domain ) ?>" value="<?php echo $email ?>" disabled>
                </div>
                <div>
                    <label for="subject"><?php echo __( 'Subject', self::$domain ) ?></label>
                    <input type="text" name="subject" data-key="subject" data-form-input="bonaire" title="<?php echo __( 'Subject', self::$domain ) ?>" value="<?php echo $subject ?>">
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea name="textarea" id="" data-key="message" data-form-input="bonaire" title="<?php echo __( 'Message', self::$domain ) ?>" cols="30" rows="10"></textarea>
                </div>
                
                <input class="button button-primary button-large bonaire-submit-reply-button" type="submit" value="<?php echo __( 'Submit', self::$domain ) ?>">
            </form>
        </div>
