...
(function ( $, alertify ){
    ...
    function BonaireAdminTest (){

        this.body = $('body');
        this.ajaxUrl = BonaireOptionsPage.ajax_url;
        ...
        // Dashboard Widget
        this.bonaireMarkAsReadButton = $('.bonaire-mark-as-read-local-button');
        ...
        this.markAsSpamButton = $('.bonaire-spam-button');
        this.moveToTrashButton = $('.bonaire-trash-button');
        // Reply Form Meta Box
        ...
        this.bonaireReplysAction = 'bonaire_submit_reply';
        // Options Page
    ...
    BonaireAdminTest.prototype = {
        ...
        bonaireEvaluateSettings: function ( event ){
            ...
            $.post(ajaxurl, data, function ( response ){
                ...
                if (undefined !== state){
                    ...
                    el.removeClass('red orenge green').addClass(state);
            ...
            $.each(data, function ( key ){
                ...
                if ('smtp_host' === key || 'imap_host' === key){
                    ...
                    if (true === result){
                        ...
                        result = '';
                        //errors[key] = $this.optionsMeta[key];
                    }
                }
                if ('smtpauth' === key){
                    result = true;
                }
                if ('save_reply' === key || 'password' === key){
                    result = this;
                }
        ...
        bonaireSubmitReply: function ( input ){
            ...
            var data = {
                action: this.bonaireReplysAction,
    ...
    $(document).one('ready', function (){
        ...
        if (true === false){
            var bonaireAdminTest = new BonaireAdminTest();
            bonaireAdminTest.init();
        }
